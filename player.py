...
class Player(arcade.Sprite):
    def __init__(self, screen_width, screen_height):
        ...
        self.scale = 1
        # movement traits
        self.max_speed = 3.0 # speed limit
        self.acceleration_rate = 0.1 # how quickly you accelerate
        self.friction = 0.02 # how quickly to slow down after letting go of movement
